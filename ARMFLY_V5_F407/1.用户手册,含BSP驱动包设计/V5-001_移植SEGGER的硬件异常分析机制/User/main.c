...
*	修改记录 :
*		版本号   日期         作者        说明
*		V1.0    2019-07-07   Eric2013     1. CMSIS软包版本 V5.5.0
*                                         2. HAL库版本 V2.4.0
*
...
/* 定义例程名和例程发布日期 */
#define EXAMPLE_NAME	"V6-移植SEGGER的硬件异常分析"
#define EXAMPLE_DATE	"2019-07-07"
#define DEMO_VER		"1.0"
...
{
	printf("操作提示:\r\n");
	printf("1. XXXXXXXXXXXXXXXXXXXXX\r\n");
	printf("2. XXXXXXXXXXXXXXXXXXXXX\r\n");
}
