...
*********************************************************************************************************
*/
void SPFD5420_DrawRect(uint16_t _usX, uint16_t _usY, uint16_t _usHeight, uint16_t _usWidth, uint16_t _usColor)
{
	/*
	 ---------------->---
	|(_usX，_usY)        |
...
*********************************************************************************************************
*/
void SPFD5420_FillRect(uint16_t _usX, uint16_t _usY, uint16_t _usHeight, uint16_t _usWidth, uint16_t _usColor)
{
	uint32_t i;

	for (i = 0; i < _usHeight; i++)
	{
		SPFD5420_DrawLine(_usX, _usY + i, _usX + _usWidth - 1, _usY + i, _usColor);
	}
}
...
*********************************************************************************************************
*/
void SPFD5420_FillCircle(uint16_t _usX, uint16_t _usY, uint16_t _usRadius, uint16_t _usColor)
{
	int32_t  D;
	uint32_t  CurX;		/* 当前 X 值 */
	uint32_t  CurY;		/* 当前 Y 值 */
	...
	while (CurX <= CurY)
	{			
		SPFD5420_DrawLine(_usX + CurX, _usY + CurY, _usX - CurX, _usY + CurY, _usColor);
		SPFD5420_DrawLine(_usX + CurX, _usY - CurY, _usX - CurX, _usY - CurY, _usColor);
		SPFD5420_DrawLine(_usX + CurY, _usY + CurX, _usX - CurY, _usY + CurX, _usColor);
		SPFD5420_DrawLine(_usX + CurY, _usY - CurX, _usX - CurY, _usY - CurX, _usColor);  			
