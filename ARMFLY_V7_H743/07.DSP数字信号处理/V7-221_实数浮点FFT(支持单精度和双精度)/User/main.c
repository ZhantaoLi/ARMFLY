...
/* 定义例程名和例程发布日期 */
#define EXAMPLE_NAME	"V7-实数浮点FTT（支持单精度和双精度）"
...
static void PrintfHelp(void)
{
	...
	printf("2. 按下按键K1，串口打印1024点实数单精度FFT的幅频响应和相频响应\r\n");
	printf("3. 按下按键K2，串口打印1024点实数双精度FFT的幅频响应和相频响应\r\n");
}
