...
*	修改记录 :
*		版本号   日期         作者        说明
*		V1.0    2019-06-01   Eric2013     1. CMSIS软包版本 V5.4.0
*                                         2. HAL库版本 V1.3.0
*
...
/* 定义例程名和例程发布日期 */
#define EXAMPLE_NAME	"V7-DAC定时器触发+DMA方式双通道同步输出"
#define EXAMPLE_DATE	"2019-06-01"
#define DEMO_VER		"1.0"
...
{
	printf("操作提示:\r\n");
	printf("1. 创建1个500ms的自动重载软定时器，每500ms翻转一次LED2\r\n"); 
	printf("2. PA4和PA5引脚输出100KHz的方波\r\n"); 
}
