...
{	 
	...
	*/
	...
	hfdcan1.Init.RxFifo0ElmtsNbr = 1;                   /* 设置Rx FIFO0的元素个数，范围0-64 */  
...
{	
	...
	*/
	...
	hfdcan2.Init.RxFifo0ElmtSize = FDCAN_DATA_BYTES_64; 	/* 设置Rx FIFO0中每个元素大小，支持8,12,16,20,24,32,48或者64字节 */   
	hfdcan2.Init.RxFifo1ElmtsNbr = 0;                   /* 设置Rx FIFO1的元素个数，范围0-64 */
	hfdcan2.Init.RxFifo1ElmtSize = FDCAN_DATA_BYTES_64;  /* 设置Rx FIFO1中每个元素大小，支持8,12,16,20,24,32,48或者64字节 */	
	...
	hfdcan2.Init.TxElmtSize = FDCAN_DATA_BYTES_64;           /* 设置Tx Element中的数据域大小，支持8,12,16,20,24,32,48或者64字节 */
