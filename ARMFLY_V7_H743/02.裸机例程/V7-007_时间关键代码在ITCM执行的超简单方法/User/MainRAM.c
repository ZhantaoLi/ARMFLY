...
/* 定义例程名和例程发布日期 */
#define EXAMPLE_NAME	"V7-时间关键代码在ITCM执行的超简单方法，同时中断向量表和变量放DTCM"
...
{
	printf("操作提示:\r\n");
	printf("1. 系统上电后驱动了1个软件定时器，每100ms翻转一次LED2\r\n");
	printf("2. 启动1个TIM6周期性中断，频率10KHz，在中断服务程序里面翻转FMC扩展引脚20和23\r\n");
	printf("3. K1按键按下，开启TIM6的周期性中断\r\n");
	printf("4. K2按键按下，关闭TIM6的周期性中断\r\n");
}
