...
*	文件名称 : main.c
*	版    本 : V1.0
*	说    明 : DMAMUX的定时器触+BDMA控制任意IO做PWM和脉冲数控制。
*              实验目的：
...
/* 定义例程名和例程发布日期 */
#define EXAMPLE_NAME	"V7-DMAMUX的定时器触+BDMA控制任意IO做PWM和脉冲数控制"
...
{
	printf("操作提示:\r\n");
	printf("1. K1键按下，PB1输出20KHz方波，占空比50%\r\n");
	printf("2. K2键按下，PB1输出10KHz方波，占空比50%\r\n");
	printf("3. K3键按下，PB1输出5KHz方波，占空比50%\r\n");
}
